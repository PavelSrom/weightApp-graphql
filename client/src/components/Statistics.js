...
const Statistics = ({ profile, logs }) => {
  ...
  return (
    <Paper className={classes.paper}>
      ...
      <Grid container>
        <Grid item xs={4}>
          <Typography variant="h5">{sessionsLeft.toFixed(0)}</Typography>
          <Typography variant="body1">sessions left</Typography>
        </Grid>
        <Grid item xs={4}>
          <Typography variant="h5">{kgLost.toFixed(0)}</Typography>
          <Typography variant="body1">kg lost</Typography>
        </Grid>
        <Grid item xs={4}>
          <Typography variant="h5">{kgLeft.toFixed(0)}</Typography>
